		...
		<form action="/admin/products/update/${product.id}" method="post">
			<div class="row">
				<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<select class="form-control border border-success" name="categoryid" readonly>
							<option value="${product.category.id}">Select a Category</option>
				...
				<div class="form-group">
						...
						<textarea class="form-control border border-success" rows="4" name="description">${ product.description }</textarea>
					</div>

					<div class="form-group">

                    <label for="Image">Image Link</label>
                    <input type="text" class="form-control border border-warning" required name="productImage" value= "${ product.image }">
